...
def refreshMode():
    if request.method == 'GET':
        ...
        if (mode == 'Manual'):
            ...
            memcache_mode['max_thr'] = request.form['max_thr']
            memcache_mode['min_thr'] = request.form['min_thr']
            memcache_mode['expand_ratio'] = request.form['expand_ratio']
            memcache_mode['shrink_ratio'] = request.form['shrink_ratio']
            try:
